...
async def mostrar_mascota_agregada(request: Request, nombre: str, grupo: str, pais: str, logo_url: str):
...
async def crear_mascota(
    ...
    await create_equipo_sql(session, mascota_db)
...
@app.get("/mascotas/", response_model=List[EquipoSQL])
